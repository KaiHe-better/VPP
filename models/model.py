...
Yes_No_token_dic = OrderedDict()
Yes_No_token_dic['no'] = ["No", "NO", "no", "wrong", "negative", "Ġdisagree", "ĠWrong", "Ġwrong", "Ġdisapproval", 
                        "Ġindefinite", "Ġincorrect", "Ġincorrectly", "Ġuntrue", "Ġimproper","False", "false", 
                        "Ġinaccurate", "Error", "error", "Ġerroneous"]
Yes_No_token_dic['yes'] = ["Yes", "YES", "yes", "Right", "right", "True", "true", "Great", "great", "Good", "good", 
                        "Sure", "sure", "agree", "positive", "Certain", "certain", "Exactly", "Correct", "correct"]

# Yes_No_token_dic = {
#     "no":  ["No", "NO", "no", "wrong", "negative", "Ġdisagree", "ĠWrong", "Ġwrong", "Ġdisapproval", 
#             "Ġindefinite", "Ġincorrect", "Ġincorrectly", "Ġuntrue", "Ġimproper","False", "false", 
#             "Ġinaccurate", "Error", "error", "Ġerroneous"],
#     "yes": ["Yes", "YES", "yes", "Right", "right", "True", "true", "Great", "great", "Good", "good", 
#             "Sure", "sure", "agree", "positive", "Certain", "certain", "Exactly", "Correct", "correct"]
# }
