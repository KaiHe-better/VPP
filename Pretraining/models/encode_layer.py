'''
Author: Andrew
Date: 2021-10-07 20:23:32
LastEditors: Andrew
LastEditTime: 2021-11-18 21:41:29
FilePath: /BART-pretrain/models/encode_layer.py
'''
import numpy as np
import torch
...
class LayerNormalization(nn.Module):
    ...
    def forward(self, z):
        ...
        ln_out = self.weight * ln_out + self.bias
...
class PromptEncodeLayer(nn.Module):
    def __init__(self, d_k=32, d_v=32, d_model=768, d_ff=768, n_heads=3, dropout=0.5):
