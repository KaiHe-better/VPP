...
class Trainer:
    ...
    def _get_train_sampler_old(self) -> Optional[torch.utils.data.sampler.Sampler]:
    ...
    def _load_state_dict_in_model(self, state_dict):
        ...
        if len(load_result.missing_keys) != 0:
            if self.model._keys_to_ignore_on_save and set(load_result.missing_keys) == set(self.model._keys_to_ignore_on_save):
